...
const defaultClasses =
  "w-2xs m-5border border-secondary border rounded-xl text-light flex flex-col gap-2 p-2";
  ...
  return (
    <div class={clsx([defaultClasses, desktopClasses])} id="projet">
      <div>
        ...
        <Paragraph
          boldValue="normal"
          class="w-fit max-h-35 text-justify pt-2 overflow-scroll"
        >
          {props.description}
        </Paragraph>
      </div>
      <div class="flex justify-between p-2 items-center">
        <div>
          <Paragraph boldValue="medium" class="italic">
            {props.statut}
          </Paragraph>
          <Paragraph boldValue="normal" class="text-lg">
            {props.type}
          </Paragraph>
        </div>
        <div>
